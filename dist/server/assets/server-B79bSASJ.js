...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Byi6CXh3.js");
...
const manifest = {
  "555e1922d231e3797a1430e2a6794ff5f3ad90629f3385daec7741d3d6705490": {
    functionName: "chatWithConcierge_createServerFn_handler",
    importer: () => import("./chat.functions-CJUuhcRa.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Vxp-61Ug.js").then((n2) => n2.r),
    import("./start-CqltOzCB.js"),
