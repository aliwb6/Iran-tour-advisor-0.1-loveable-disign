...
import { L as Link } from "./router-Vxp-61Ug.js";
...
const SplitNotFoundComponent = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container-luxe pt-40 pb-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/packages", className: "mt-4 inline-block text-accent", children: "← Back" })
  ] }),
