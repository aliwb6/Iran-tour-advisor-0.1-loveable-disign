import { _ as TSS_SERVER_FUNCTION, a0 as createServerFn } from "./server-B79bSASJ.js";
...
const chatWithConcierge_createServerFn_handler = createServerRpc({
  id: "555e1922d231e3797a1430e2a6794ff5f3ad90629f3385daec7741d3d6705490",
  name: "chatWithConcierge",
  filename: "src/lib/chat.functions.ts"
}, (opts) => chatWithConcierge.__executeServer(opts));
...
}).handler(chatWithConcierge_createServerFn_handler, async ({
  data
}) => {
...
export {
  chatWithConcierge_createServerFn_handler
};
