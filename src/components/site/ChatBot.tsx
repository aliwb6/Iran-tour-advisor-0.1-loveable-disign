...
export function ChatBot() {
  ...
  return (
    <div className="flex h-[min(640px,80vh)] w-[min(420px,calc(100vw-2rem))] flex-col overflow-hidden rounded-3xl border border-border/60 bg-background shadow-luxe">
      {/* Header */}
